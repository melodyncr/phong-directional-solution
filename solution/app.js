...
function createScene() {
    ...
    // var barrelScale = new Matrix4().makeScale(0.05, 0.05, 0.05);
    // var barrelTranslation = new Matrix4().makeTranslation(0, 1.5, 0);
...
function updateAndRender() {
    ...
    var lightRadius = 5.0; // You can adjust the radius as needed
    var lightPosition = new Vector4(lightRadius * Math.cos(time.totalElapsedSeconds), 1.5, lightRadius * Math.sin(time.totalElapsedSeconds), 1.0);
    time.update();
